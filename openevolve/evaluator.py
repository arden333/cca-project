...
CLIENT_MEASURE_EXTERNAL = "34.79.170.95"
CLIENT_AGENT_A_INTERNAL = "10.0.16.8"
CLIENT_AGENT_B_INTERNAL = "10.0.16.5"
CLIENT_AGENT_A_EXTERNAL = "34.79.219.149"
CLIENT_AGENT_B_EXTERNAL = "34.62.102.96"
...
PROGRAM_TIMEOUT = 690  # evaluator timeout(700)보다 작게 → OpenEvolve handler 절대 안 발동
...
def evaluate(program_path: str) -> EvaluationResult:
    ...
    for f in ["mcperf_output.txt", "makespan.txt", "result.json"]:
        if os.path.exists(f):
            os.remove(f)
